package com.example.testingmyentertainment.AcDc;
...
public class AcDc extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new ArrayAdapter<String>(this, R.layout.list_item_song, R.id.item_song_title, songNames) {
            @NonNull
            @Override
        ...
        listView.setOnItemClickListener((parent, view, position, id) -> {
            ...
            if (selectedItem != null) {
                ...
                if (actualIndex >= 0 && actualIndex < songUrls.length) {
                    Intent intent = new Intent(AcDc.this, PlayerActivity.class);
